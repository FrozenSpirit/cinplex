...
const GenreMain = ({title, requestURL}) => {
  ...
  return (
    <section className='relative h-[600px] w-full'>
        ...
        <Carousel className='w-full h-[600px] absolute' autoPlay={true}  showThumbs={false} infiniteLoop={true} showStatus={false} interval={5000} showArrows={false}>
